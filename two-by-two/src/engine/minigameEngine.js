...
// Which minigame type each activity uses
export const ACTIVITY_MINIGAME_MAP = {
  study_language: 'typing',
  teach_lesson: 'cards',
  street_contact: 'dialogue',
  companion_study: 'memory',
  service_project: 'service',
  english_class: 'fillblanks',
  personal_study: 'speedread',
  member_visit: 'dialogue',
  // P-Day activities
  pday_study: 'typing',
  letters_home: 'speedread',
  explore_city: null, // no minigame, auto-resolve
  laundry: null,
  shopping: null,
  sports: null,
  companion_activity: 'memory',
  // Visit investigator
  visit_investigator: 'cards',
  // Shopping activities
  buy_food: null,
